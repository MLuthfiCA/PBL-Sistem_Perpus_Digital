...
<div class="py-10 space-y-8" x-data="{}">
    <x-ui.page-header title="Tambah Pengguna" subtitle="Formulir untuk menambahkan pengguna baru"></x-ui.page-header>
    <div class="p-6 bg-white/80 rounded-2xl shadow-xl">
        <form action="{{ route('admin.users.store') }}" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="col-span-2 flex justify-end space-x-4">
                ...
                <button type="submit" class="px-6 py-2.5 bg-burgundy-500 text-white rounded-xl hover:bg-maroon">Simpan</button>
            </div>
        </form>
    </div>
</div>
