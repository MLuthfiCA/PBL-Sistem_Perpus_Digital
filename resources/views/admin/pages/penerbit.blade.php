...
<div class="py-10 space-y-8">
    ...
    <form action="{{ route('admin.penerbit.index') }}" method="GET" class="p-6 bg-white/80 rounded-2xl shadow-xl">
        <div class="flex flex-col md:flex-row gap-4 items-center">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('admin.penerbit.index') }}" class="px-6 py-2.5 bg-gray-200 text-gray-700 rounded-xl hover:bg-gray-300 font-bold text-sm transition-all">Reset</a>
            </div>
        </div>
    </form>
