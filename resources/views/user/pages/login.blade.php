...
@section('content')
<div class="md:min-h-[80vh] flex items-center justify-center py-4 md:py-12 px-4 sm:px-6 lg:px-8 mt-8 md:mt-0">
                    ...
                    <div>
                        ...
                        <div class="relative w-full">
                            <input id="password" name="password" type="password" required 
                                class="appearance-none relative block w-full px-4 py-4 border border-white bg-white/50 rounded-2xl placeholder-gray-400 text-gray-800 focus:outline-none focus:ring-4 focus:ring-red-100 focus:border-burgundy-500 transition-all sm:text-sm font-medium pr-12" 
                                placeholder="••••••••">
                            <button type="button" id="togglePassword" class="absolute inset-y-0 right-0 pr-4 flex items-center text-gray-400 hover:text-burgundy-500 transition-colors focus:outline-none">
