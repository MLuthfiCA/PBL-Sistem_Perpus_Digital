...
<div class="space-y-6 sm:space-y-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
        <div class="glass-panel p-5 sm:p-6 animate-fade-up delay-100 group hover:bg-burgundy-500 transition-all duration-500 border-white/60">
            <div class="flex items-center justify-between mb-3 sm:mb-4">
                <div class="p-2.5 sm:p-3 rounded-2xl bg-burgundy-100 text-burgundy-800 group-hover:bg-burgundy-400 group-hover:text-white transition-colors">
            ...
            <h3 class="text-2xl sm:text-3xl font-bold text-gray-800 group-hover:text-white">{{ number_format($totalBuku) }}</h3>
        </div>
        ...
        <div class="glass-panel p-5 sm:p-6 animate-fade-up delay-200 group hover:bg-maroon transition-all duration-500 border-white/60">
            <div class="flex items-center justify-between mb-3 sm:mb-4">
                <div class="p-2.5 sm:p-3 rounded-2xl bg-red-100 text-red-800 group-hover:bg-burgundy-400 group-hover:text-white transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 sm:h-6 sm:w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <h3 class="text-2xl sm:text-3xl font-bold text-gray-800 group-hover:text-white">{{ number_format($totalMember) }}</h3>
        </div>
        ...
        <div class="glass-panel p-5 sm:p-6 animate-fade-up delay-300 group hover:bg-burgundy-900 transition-all duration-500 border-white/60">
            <div class="flex items-center justify-between mb-3 sm:mb-4">
                <div class="p-2.5 sm:p-3 rounded-2xl bg-emerald-100 text-emerald-800 group-hover:bg-burgundy-800 group-hover:text-white transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 sm:h-6 sm:w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <h3 class="text-2xl sm:text-3xl font-bold text-gray-800 group-hover:text-white">{{ $availablePercent }}%</h3>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 animate-fade-up delay-300">
        ...
        <div class="lg:col-span-1 space-y-3">
            ...
            <div class="glass-panel p-3 sm:p-4 flex items-center justify-between group hover:border-burgundy-500 transition-all cursor-pointer border-white/60">
                ...
                <span class="text-xs font-bold text-burgundy-500 bg-red-50 px-2 py-1 rounded-lg whitespace-nowrap ml-2">{{ $genre['count'] }} {{ $genre['count'] == 1 ? 'book' : 'books' }}</span>
            </div>
            @empty
            ...
            <div class="flex items-center justify-between mb-6 sm:mb-8 gap-4">
                <div>
                    <h3 class="text-lg sm:text-xl font-bold text-gray-800 flex items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-burgundy-500 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z" />
                        </svg>
                        <span>Weekly Lending Trends</span>
                    </h3>
    ...
    <div class="glass-panel p-6 sm:p-8 animate-fade-up delay-300 border-white/60">
        <h3 class="text-lg sm:text-xl font-bold text-gray-800 mb-4 sm:mb-6">Trending Category</h3>
